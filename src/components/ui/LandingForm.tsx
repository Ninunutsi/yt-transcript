...
const LandingForm = () => {
  ...
  return (
    <div className="bg-bg_blue rounded-2xl py-5 border px-4  mt-10 sm:mt-14  mx-auto">
      <p className="text-ghost_white sm:text-base mb-3 flex gap-2 sm:gap-3 leading-relaxed">
        <AiOutlineInfoCircle
          size={15}
      ...
      <Button
        ...
        onClick={handleDemo}
        disabled={loading}
        className="cursor-pointer w-full mt-6  py-3 sm:py-4 flex items-center justify-center rounded-xl"
      >
        {loading ? (
          ...
          <p className="font-md">Try a demo</p>
        )}
      </Button>
    </div>
  );
